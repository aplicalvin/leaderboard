...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 relative">
    ...
    @php
        ...
        $member = [
            'name' => 'Alex Chen',
            'nim' => '202310045',
            'avatar' => \App\Http\Controllers\Controller::getAvatarUrl('202310045', 'Alex Chen'),
            'total_score' => 9850,
            'classes' => [
                [
                    'id' => 1,
            ...
            'point_history' => [
                ['task_title' => 'Completed Web Security Module', 'points' => 500, 'time' => '2 hours ago', 'color' => 'text-mariner-500'],
                ['task_title' => 'Weekly Quiz: Networking', 'points' => 150, 'time' => 'Yesterday', 'color' => 'text-mariner-500'],
                ['task_title' => 'Hackathon Participation', 'points' => 2000, 'time' => '3 days ago', 'color' => 'text-mariner-500'],
                ['task_title' => 'Forum Help Contribution', 'points' => 50, 'time' => '1 week ago', 'color' => 'text-mariner-500'],
            ]
        ];
    @endphp
                ...
                <div class="relative z-10 space-y-4">
                    ...
                    <div class="group flex items-center justify-between p-3 rounded-xl hover:bg-mariner-50 transition-colors border border-transparent hover:border-mariner-200">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h4 class="text-mariner-900 font-bold group-hover:text-mariner-600 transition-colors">{{ $history['task_title'] }}</h4>
                                <p class="text-xs text-mariner-500 mt-1 font-semibold">{{ $history['time'] }}</p>
                            </div>
                        </div>
                        <div class="text-right">
                            <span class="text-lg font-black {{ $history['color'] }} group-hover:scale-110 inline-block transition-transform">+{{ number_format($history['points']) }}</span>
