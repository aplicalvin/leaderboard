...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 relative">
        ...
        <div class="glass-panel bg-white/90 rounded-[2.5rem] p-8 md:p-10 flex flex-col md:flex-row items-center gap-8 shadow-md border-mariner-100">
            ...
            <div class="flex-grow text-center md:text-left">
                ...
                <div class="mt-2 text-center md:text-left">
                    <button onclick="downloadIGStory()" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white rounded-xl font-bold shadow-md hover:shadow-lg hover:shadow-orange-500/30 transform transition-all hover:-translate-y-1">
    ...
    @include('components.member-story', ['member' => $member])
</div>
